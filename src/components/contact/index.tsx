...
export function Contact({ id, className }: SectionProps) {
    return (
        <div className={ className } id={ id }>
            ...
            Fugiat itaque autem reprehenderit sunt vero, unde maxime ab eligendi, earum laborum vitae ullam culpa repudiandae repellat impedit. Distinctio, soluta officia! Placeat quae dicta fugit nobis nemo. Dolore, esse totam?
            Repellendus commodi quos consequuntur pariatur, maiores esse tempora id ipsum illo natus nesciunt unde quaerat earum eum! Unde, repudiandae obcaecati laboriosam voluptatum, eveniet voluptate ipsum autem impedit ea, in quo.
        </div>
    )
}